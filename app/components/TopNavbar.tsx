...
export default function TopNavbar() {
  ...
  return (
    ...
    >
      <div
        className="max-w-7xl mx-auto flex justify-between items-center px-5 md:px-8 py-3.5 transition-all duration-500"
        style={{
          background: scrolled ? 'rgba(2, 6, 23, 0.85)' : 'rgba(15, 23, 42, 0.55)',
          backdropFilter: 'blur(24px)',
          WebkitBackdropFilter: 'blur(24px)',
          border: '1px solid rgba(255,255,255,0.07)',
          borderRadius: '2rem',
          boxShadow: scrolled ? '0 4px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(6,182,212,0.08)' : '0 4px 32px rgba(0,0,0,0.2)',
        }}
      >
        {/* Logo */}
